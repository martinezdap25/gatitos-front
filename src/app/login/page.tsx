...
const LoginPage = () => {
  ...
  return (
    <div className="pb-18 flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-900/50 px-4">
